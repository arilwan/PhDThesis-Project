...
%This chapter proceeds as follows. Related work in \Cref{chp4-rlt-work}. \Cref{chp4-sec2} presents a detailed description of the experimental procedures employed in this study. \Cref{chp4-sec3} outlines the classification algorithms used, while \Cref{chp4-sec4} discusses the evaluation metrics employed to assess the performance of the different models. \Cref{chp4-sec5} introduces sequential feature selection as a baseline approach. Subsequently, \Cref{chp4-sec6} introduces our proposed Class-Subspace Feature Selection method. The results obtained from our experiments are presented in \Cref{chp4-sec7} and analysed in \Cref{chp4-sec8}. Finally, \Cref{chp4-sec9} concludes the chapter by summarising the study's main findings and outlining potential directions for future research.

This chapter is organized as follows. We begin in \Cref{chp4-rlt-work} by the reviewing related work. Next, \Cref{chp4-sec2} details the experimental procedures employed in this study. In \Cref{chp4-sec3}, we outline the classification algorithms used, followed by a discussion of the evaluation metrics employed to assess the performance of the different models in \Cref{chp4-sec4}. \Cref{chp4-sec5} introduces sequential feature selection as a baseline approach. Subsequently, \Cref{chp4-sec6} introduces our proposed Class-Subspace Feature Selection method. The results obtained from our experiments are presented in \Cref{chp4-sec7} and analyzed in \Cref{chp4-sec8}. Finally, \Cref{chp4-sec9} concludes the chapter by summarizing the study's main findings and outlining potential directions for future research.
...
While prior research has recognised the potential of feature selection in TMD, its specific significance remains largely unexplored. This gap necessitates further investigation. 
...
\begin{table}%[tbhp]
    \caption{Summary of TMD studies from GPS data.}
    \centering
    \begin{tabular}{lcclccc}
        ...
        \cite{xiao2017identifying} & 69 & > 5 years &
            \begin{tabular}{@{}l@{}}
        ...
        \cite{bantis2017you} & 2 & 3 days &
          %  \begin{tabular}{@{}l@{}}
             Speed statistics.   
          %  \end{tabular}
            & HMM & 4 & 78 \\

        \cite{bolbol2012inferring} & 81 & 2 weeks & 
            \begin{tabular}{@{}l@{}}
                Velocity \& acceler- \\
                ation stats.
            \end{tabular} 
        ...
        \cite{dabiri2018inferring} & 69 & > 5 years &
            \begin{tabular}{@{}l@{}}
                Speed, acceleration \\
                jerk, bearing rate.
            \end{tabular}
        ...
        \cite{song2016deeptransport} & 1.6m users & 3 years & 
            \begin{tabular}{@{}l@{}}
                Auto-extracted (deep) \\
                features.
            \end{tabular}
        ...
        \cite{xiao2019detecting} & 203 & 10 months & 
            \begin{tabular}{@{}l@{}}
                Spped, acceleration \\
                \& heading change.
            \end{tabular}
        ...
        \cite{rodrigues2017impact} & 227 & 1 month &
            \begin{tabular}{@{}l@{}}
                Spped, acceleration \\
                statistics.
            \end{tabular}
        ...
        \cite{yang2022data} & 410 & 10 months &
             \begin{tabular}{@{}l@{}}
                Spped statistics \\
                \& location data.
            \end{tabular}
        ...
        \cite{hong2023evaluating} & 139 & 12 months &
            \begin{tabular}{@{}l@{}}
        ...
        \cite{sadeghian2022stepwise} & 20 & 5 months &
            \begin{tabular}{@{}l@{}}
                Distance, speed \& \\
                acceleration stats.
            \end{tabular}
         ...
         \cite{sadeghian2024deep} & 91 & 12 months  &
            \begin{tabular}{@{}l@{}}
            Speed, acceleration \\
                bearing rate
            \end{tabular}
         ...
         \cite{zeng2024masked} & 69 & > 5 years &
         \begin{tabular}{@{}l@{}}
         ...
         \cite{fan2024multi} &69 & > 5 years &
            \begin{tabular}{@{}l@{}}
                Velocity,acceleration, \\distance, heading, \\ and curvature.
            \end{tabular}
        & CNN & 5 & 95.16 \\
