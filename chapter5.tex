...
We utilised the GPS trajectories datasets described in \Cref{chp3-sec1}. The data preprocessing steps and feature engineering, are described in detail in \Cref{data-preprocessing}. Together, each instance is composed of the following features:
\begin{itemize}
