...
%    \item Investigate the effectiveness of hierarchical classification approaches for improving the accuracy of transportation mode detection, considering the challenges posed by real-world GPS trajectory data. This objective is addressed in detail in \Cref{chap5}. 
    ...
    \item To investigate the effectiveness of hierarchical classification approaches in improving TMD accuracy, analysing the impact of different hierarchical structures, and exploring methods for optimising hierarchical classifiers for TMD. This objective is addressed in detail in \Cref{chap5}.
...
\begin{enumerate}
    \item A. R. Muhammad, A. Aguiar, and J. Mendes-Moreira, "From attribution to selection: harnessing SHAP values for class-subspace feature selection in transportation mode detection" [to be submitted to Applied Intelligence].
